...
void Genetic_AlgorithmApp::setup()
{
	...
	/*cinder::gl::glGetIntegerv​(GL_MAJOR_VERSION, *);
	cinder::gl::glGetIntegerv​(GL_MINOR_VERSION, *);*/
	/*try {
		mShader = gl::GlslProg::create(loadResource(SHADER_VERT), loadResource(SHADER_FRAG));
		//mShader = gl::GlslProg::create(("resources/instancing.vs"), ("resources/instancing.frag"));
	}
