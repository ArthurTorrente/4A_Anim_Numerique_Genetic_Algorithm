...
void VertexBuffer::configureVertexAttributes()
{
	...
	glUniform3f(glGetUniformLocation(_shader->getProgramHandle(), "dirLight.ambient"), 0.1f, 0.1f,0.1f);
	glUniform3f(glGetUniformLocation(_shader->getProgramHandle(), "dirLight.diffuse"), 0.9f, 0.9f, 0.9f);
	glUniform3f(glGetUniformLocation(_shader->getProgramHandle(), "dirLight.specular"), 0.8f, 0.8f, 0.8f);*/
